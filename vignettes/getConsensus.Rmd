...
Before running a full fasta, you can check the first n contigs of a full sized fasta using the argument test_with_n. Note that the full fasta will be read in to ensure appropriate seqinfo data
```{r, eval=F}
fasta="abigfasta.fa"
#fasta="~/Desktop/GENDX_HLA_Mix1_S1_L001_t1000.fa"
